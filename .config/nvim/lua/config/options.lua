...
opt.foldexpr = "v:lua.vim.treesitter.foldexpr()" -- builtin treesitter foldexpr (the legacy nvim_treesitter#foldexpr() is slow/deprecated)
opt.foldlevel = 20
opt.synmaxcol = 500 -- skip syntax highlighting past this column; critical for minified JSON / long lines
